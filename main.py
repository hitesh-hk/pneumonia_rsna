...
train_path = root+'/stage_2_train_images'
test_path = root+'/stage_2_test_images'
train_txt = root+'/train_labels.txt'
...
def main():
    ...
    # checkpoint = torch.load('/home/Drive2/rsna_pneumonia_code/weights/checkpoint.pth.tar', map_location={'cuda:0'}) 
    ...
    # optimizer = optim.Adadelta(model.parameters(),lr=0.001, weight_decay=1e-5)
